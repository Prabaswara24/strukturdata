package e31192259_queue;
import java.util.Scanner;
public class E31192259_Queue{
    int id;
    String nama,perlu;
    E31192259_Queue next;
...
class linked{
    E31192259_Queue head,tail;
    public linked(){
        head=null;
        tail=null;
    }
    public void enque(){
        E31192259_Queue baru=new E31192259_Queue();
        baru.input();
    ...
    public void view(){
        if(head==null)System.out.println("- Kosong -");
            ...
            for(E31192259_Queue a=head; a!=null; a=a.next) a.read();
        }
    }
}